...
\section{Initial Configuration Problems}
...
\section{Ways to Connect to Cisco Routers and Switches}
...
\section{Protecting the Console Port with a Password}
...
\subsection{Automatically Enabling Privileged Mode}
...
\subsection{Setting User Privilege}
...
\section{Switch Management Interface}
...
\section{Assigning a Default Gateway to a Switch}

\begin{verbatim}
ip default-gateway 192.168.0.1
\end{verbatim}

\section{Interface Range}
